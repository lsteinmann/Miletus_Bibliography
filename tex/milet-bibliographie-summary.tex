...
\lohead{{\Large{\textbf{The Miletus Bibliography}}}}
\rohead{\includegraphics[height=2.5cm]{../data/figures/milet-logo-tr}}
%\ohead{}
...
The bibliography is edited and managed in a \redhref{https://www.zotero.org/groups/4475959/milet_bibliography}{publicly accessible Zotero group library}. By joining the group, anyone has access to a synchronized version of the bibliography via their Zotero client. For those that prefer other literature management software, the website of the Miletus Excavation offers exports of the bibliography in various formats as downloads, namely: \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/Milet_Bibliography_BibLaTeX.bib}{BibLaTeX}, \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/Milet_Bibliography_BibTeX.bib}{BibTeX}, \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/Milet_Bibliography_CSV.csv}{CSV}, \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/Milet_Bibliography_RIS.ris}{RIS}. These should cover the option to import into any literature management software.\\
...
\begin{itemize}
    \item \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/milet-bibliographie-by-tag-pdf.pdf}{Milet-Bibliographie, by keyword (PDF)}\\
    ...
    \item \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/milet-bibliographie-by-year-pdf.pdf}{Milet-Bibliographie, chronological (PDF)}\\
    Chronologically ordered, with a section on each year in which publications exist. 
    \item \redhref{https://github.com/Miletus-Excavation/Miletus_Bibliography/releases/latest/download/milet-bibliographie-by-author-pdf.pdf}{Milet-Bibliographie, by author (PDF)}\\
